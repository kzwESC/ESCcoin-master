...
int64 nChainStartTime = 1474112953;
...
const string strMessageMagic = "EveryoneSharesCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in EveryoneSharesCoin
    bool fStrictPayToScriptHash = true; // Always active in EveryoneSharesCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "EveryoneSharesCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "ckInd vector empty test block spacing is Coin";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 555064 : 555064;
        printf("block.GetHash() == %s\n", block.GetHash().ToString().c_str());
        printf("block.hashMerkleRoot == %s\n", block.hashMerkleRoot.ToString().c_str());
        printf("block.nTime = %u \n", block.nTime);
        printf("block.nNonce = %u \n", block.nNonce);
		block.print();
		assert(block.hashMerkleRoot == uint256("0xa5e47c80506c9c926857935e69fa8753501c95d33dbbb24cd98ed874bf3aef41"));
...
unsigned char pchMessageStart[4] = { 0xf1, 0xd8, 0xb2, 0xfe };
